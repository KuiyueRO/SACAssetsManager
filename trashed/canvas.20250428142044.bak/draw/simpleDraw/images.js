import { computeFitScale, FitModeType } from "../../../../toolBox/base/useLayout/computeFitScale.js";
import { 蒙版到节点形状 } from "../../../../toolBox/feature/useProceduralImageGeneration/pattern/utils/index.js";
export function 以位置配置在画布上下文绘制图像(ctx, image, config) {
    ...
    ctx.scale(scale * fitScale.scaleX, scale * fitScale.scaleY);
    // 绘制图片，相对于中心位置
    ctx.drawImage(
        image,
        -width / 2,
